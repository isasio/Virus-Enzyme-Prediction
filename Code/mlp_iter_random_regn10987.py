...
for i in range(1, 501):
    ...
    file_output = f'mlp_correct_predictions_class_20seq_20_{i}.csv'
    history_output = f'mlp_training_history_iter_20seq_20_{i}.csv'
    ...
    # Load the data
    data = pd.read_csv('lasso_prediction_REGN10987_aic_opt_order_biochem.txt', sep='\s+')
    ...
    for iteration in range(iterations):
        ...
        # Train the Regressor
        regressor = MLPRegressor(hidden_layer_sizes=(5,), max_iter=5000)
        regressor.fit(selected_genotypes, selected_targets_regressor)

        # Train the Classifier
        classifier = MLPClassifier(hidden_layer_sizes=(5,), max_iter=5000)
